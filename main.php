                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><strong>Financial Debit Report</strong></p>
                                            <?php echo $row01; ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><strong>Financial Credit Report</strong></p>
                                            <?php echo $row05; ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><strong> Save Income Values</strong></p>
                                            <?php echo $row06; ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><strong>Update Cash Collection</strong></p>
                                            <?php echo $row03; ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><strong>Incomes & Expenses per Month</strong></p>
                                            <?php echo $row07; ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><strong>Loan Calculator Tool</strong></p>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><strong>Simple Math Calculator</strong></p>
            ...
            <div class="container-fluid">
                ...
                <!--row begins-->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Recent Income Collection (Daily Updates)</h4>
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><strong>Income Structure</strong></p>
                                            <?php echo $row03; ?>
                                        </div>
                                    </div>
                                </div>
