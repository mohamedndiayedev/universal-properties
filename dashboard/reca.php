  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">BANK RECA.MEGA</h5>
    ...
    <form action="code-reca.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="recabtn" class="btn btn-primary">Save</button>
        </div>
    </form>
...
<!--               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addadminprofile">
        ...
        <p><strong>Mega Bank Reconciliation Statement</strong></p>
        </h6>
     </div>
      <div class="table-responsive">

       <?php 
           $query = "SELECT * FROM reca";
       ...
       ?>
           <table class="table table-striped" id="dataTable" while="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Balance as per Cash Book (GMD):</th>
                            <th>Less: Uncleared Cheque<br/>Details:</th>
                            <th>Less: Uncleared Cheque<br/>Amount (GMD):</th>
                            <th>Less Bank Charges:</th>
                            <th>Closing Balance per Reconcilition (GMD)<br/>
                            Bank Statement:</th>
                            <th>Comment:</th>
                            <th>Modify</th>
                            <th>Delete</th>
          ...
          while ($row = mysqli_fetch_assoc($query_run)) 
          {
            ?>
                        <tr>
                            ...
                            <td>
                              <form action="edit-reca.php" method="post">
