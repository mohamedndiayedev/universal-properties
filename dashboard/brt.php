  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">TBL BANK RECONCILIATION</h5>
    ...
    <form action="code-brt.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="brtbtn" class="btn btn-primary">Save</button>
        </div>
    </form>
      ...
      <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">TBL Bank Reconciliation File
...
<!--               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addadminprofile">
        ...
        <p><strong>TBL Bank Reconciliation Statement</strong></p>
        </h6>
     </div>
          ...
          while ($row = mysqli_fetch_assoc($query_run)) 
          {
            ?>
                        <tr>
                            ...
                            <td>
                              <form action="edit-brt.php" method="post">
                        ...
                        <button type="submit" name="deletebrt" class="btn btn-danger" >Delete</button>
                              </form>
                            </td>
                    </tr>
     <?php
