...
<!-- Page Content -->
  <div class="container">
    ...
    <!-- Page Heading -->
    <h1 class="mt-4 mb-3">
      <p class="text-center text-primary font-weight-bold">Fiancial Debit Statement</p>
    </h1>
    ...
    <div>
        ...
        <a href="expenses_report.php" target="_blank" class="btn btn-success">
          <i class="fas fa-print"></i> print debit
        </a>
    ...
    <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table font-weight-bold"></i> Debit Table
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="expense_form">
            ...
            <div class="form-group">
              <label for="title">Amount Debit (GMD)</label>
