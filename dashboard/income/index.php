...
<!-- Page Content -->
  <div class="container">
    ...
    <!-- Page Heading -->
    <h1 class="mt-4 mb-3">
      <p class="text-center text-primary font-weight-bold">Income Statement</p>
    </h1>
    ...
    <div>
        ...
        <a href="expenses_report.php" target="_blank" class="btn btn-success">
          <i class="fas fa-print"></i> print income file
        </a>
        <a href="../simple-calculator" class="btn btn-success">
          <i class="fas fa-calculator"></i> Simple Math Calculator
        </a>
        <a href="../../index.php" class="btn btn-success">
          <i class="fas fa-home"></i> Go Dashboard
          <style>#col{color:red;};</style>
        </a><br> <h4 id="col">Tax Rate Value = 10 % (if necessary, you can apply the tax rate.)</h4>
    </div>
    <br>
    <!-- Expenses DataTable -->
    <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table font-weight-bold"></i> Income Table
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="expense_form">
            ...
            <div class="form-group">
              <label for="title">Amount (GMD)</label>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $(document).on('click', '.delete_expense', function(){
      ...
      swal({
        title: "Are you sure?",
        text: "You want to delete this debit!",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      })
      .then((willDelete) => {
        if (willDelete) {
            ...
            success:function(data){
              datatable.ajax.reload();
              swal("Debit GMD has been successfully deleted!", {
                icon: "success",
              });
            },
            error:function(){
