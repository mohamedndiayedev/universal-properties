<?php
	...
	class PDF extends FPDF {
		function Header(){
			...
			$this->Image('images/ex.jpeg',20,10,30);

			$this->Ln(4);
			
			$this->SetTextColor(7, 56, 99);
			$this->SetX(120);
			$this->Write(5, 'Universal Properties');
			$this->Ln();
			$this->SetX(120);
			$this->Write(5, '1st Floor FIB House, Kairaba');
			$this->SetX(120);
			$this->Ln();
			$this->SetX(120);
			$this->Write(5, 'Avenue, Serrekunda');

			$this->SetY(15);
			$this->SetFont('Arial', 'B', 30);
			$this->Ln(30);
			$this->SetX(65);
			$this->Write(5, 'List of Credits');
	...
	$query = mysqli_query($connect,"select * from tbl_expense1");
	...
	$pdf->Output('I','financial_report.pdf');
