...
<div class="modal fade" id="addadminprofile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form action="boiler-code.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="boilerbtn" class="btn btn-primary">Save</button>
        </div>
    </form>
      ...
      <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">BROILER STARTER File
          ...
          while ($row = mysqli_fetch_assoc($query_run)) 
          {
            ?>
                        <tr>
                            ...
                            <td>
                              <form action="edit-boiler.php" method="post">
                                <input type="hidden" name="edit_id" value="<?php echo $row['id']; ?>"> 
                                <button type="submit" name="edit_btn" class="btn btn-success">Modidy</button>
                             </form>
                            </td>
                            <td>
                             <form action="delete-boiler.php" method="post"> 
                             <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?>"> 
                        <button type="submit" name="delete_boiler" class="btn btn-danger" >Delete</button>
                              </form>
                            </td>
                    </tr>
     <?php
