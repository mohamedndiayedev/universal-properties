  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">MEGA BANK RECONCILIATION</h5>
    ...
    <form action="code-brm.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="brmbtn" class="btn btn-primary">Save</button>
        </div>
    </form>
      ...
      <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Mega Bank Reconciliation File
          ...
          while ($row = mysqli_fetch_assoc($query_run)) 
          {
            ?>
                        <tr>
                            ...
                            <td>
                              <form action="edit-brm.php" method="post">
                        ...
                        <button type="submit" name="deletebrm" class="btn btn-danger" >Delete</button>
                              </form>
                            </td>
                    </tr>
     <?php
