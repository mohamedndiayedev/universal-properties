  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">FIB BANK RECONCILIATION</h5>
    ...
    <form action="code-brf.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="brfbtn" class="btn btn-primary">Save</button>
        </div>
    </form>
...
<!--               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addadminprofile">
        ...
        <p><strong>FIB Bank Reconciliation Statement</strong></p>
        </h6>
     </div>
      <div class="table-responsive">

       <?php 
           $query = "SELECT * FROM brf";
          ...
          while ($row = mysqli_fetch_assoc($query_run)) 
          {
            ?>
                        <tr>
                            ...
                            <td>
                              <form action="edit-brf.php" method="post">
                        ...
                        <button type="submit" name="deletebrf" class="btn btn-danger" >Delete</button>
                              </form>
                            </td>
                    </tr>
     <?php
