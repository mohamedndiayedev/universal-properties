...
<div class="modal fade" id="addadminprofile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form action="code-sold.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="soldbtn" class="btn btn-primary">Save</button>
        </div>
    </form>
      ...
      <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Check Sold Products
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addadminprofile">
                  Add Sold Land Product
              </button>
        </h6>
     </div>
          ...
          while ($row = mysqli_fetch_assoc($query_run)) 
          {
            ?>
                        <tr>
                            ...
                            <td>
                              <form action="edit-sold.php" method="post">
                        ...
                        <button type="submit" name="deletesold" class="btn btn-danger" >Delete</button>
                              </form>
                            </td>
                    </tr>
     <?php
