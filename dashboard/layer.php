  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">LAYER STARTER</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true"&times;</span>
        </button>
      </div>
    <form action="layer-code.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="layerbtn" class="btn btn-primary">Save</button>
        </div>
    </form>
      ...
      <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">LAYER STARTER File
          ...
          while ($row = mysqli_fetch_assoc($query_run)) 
          {
            ?>
                        <tr>
                            ...
                            <td>
                              <form action="edit-layer.php" method="post">
                                <input type="hidden" name="edit_id" value="<?php echo $row['id']; ?>"> 
                                <button type="submit" name="edit_btn" class="btn btn-success">Modidy</button>
                             </form>
                            </td>
                            <td>
                             <form action="delete-layer.php" method="post"> 
                             <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?>"> 
                        <button type="submit" name="delete_layer" class="btn btn-danger" >Delete</button>
                              </form>
                            </td>
                    </tr>
     <?php
